...
namespace LTWNC.Controllers
{
    public class KHUYENMAIsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDKM,TENKM,GIATRI,NGAYTAO,NGAYHET")] KHUYENMAI kHUYENMAI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDKM,TENKM,GIATRI,NGAYTAO,NGAYHET")] KHUYENMAI kHUYENMAI)
        {
            if (ModelState.IsValid)
            {
